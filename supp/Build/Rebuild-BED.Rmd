...
##
warning("change: BED.5 (in helpers and vignette also), reDumpThr=4")
##
library(knitr)
library(BED.5)
##
...
## General config
reDumpThr <- as.difftime(400, units="days")
curDate <- Sys.Date()
```
...
print(bedInstance)
print(bedVersion)
BED.5:::setBedVersion(bedInstance=bedInstance, bedVersion=bedVersion)
```
...
be <- "Gene"
##
BED.5:::loadPlf(name=platName, description=platDesc, be=be)
