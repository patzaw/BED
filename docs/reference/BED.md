...
complete and can be enriched by mappings provided by other resources.
More interestingly, direct mappings not identified by any of these
resources can be indirectly inferred by using mappings to a third
...
organisms should be possible using gene orthologs information.

- [Vignette](https://patzaw.github.io/BED/doc/BED.md)
