...
The aim of the [BED](https://patzaw.github.io/BED/)
(Biological Entity Dictionary) R package is to get
...
A public instance of the [BED Neo4j database](#docker_image)
...
issues with this image running on Docker in Windows. It's mainly solved by
