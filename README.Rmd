...
A public instance of the [BED Neo4j database](#bed_db)
...
<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
## Available BED database instance {#bed_db}
...
in [Zenodo](https://zenodo.org/records/10521413).
...
```{r, echo=FALSE, results='asis'}
ec <- readLines(here("supp/Build/SXX-Importing-BED-DB.sh"))
cat('```sh', sep="\n")
cat(ec, sep="\n")
cat('```', sep="\n")
```
