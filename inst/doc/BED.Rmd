...
The `useCache` parameter is by default set to `FALSE`.
However, it is recommended to set it to `TRUE` to improve the speed
of recurent queries: the results of some large queries are saved localy
in a file.
...
This application relies a Shiny module made to facilitate the development
