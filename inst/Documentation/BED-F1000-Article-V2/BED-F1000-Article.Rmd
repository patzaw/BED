...
abstract: The understanding of molecular processes involved in
   ...
   by different resources to increase the efficiency of the mapping process
...
All BEID from a specific scope can be get with the `getBeIds` function.
...
On the other hand a BEID which *is_associated_to* to another one does not
...
with different experimental designs:
   ...
   ((E-GEOD-13355)[https://www.ebi.ac.uk/arrayexpress/experiments/E-GEOD-13355/])
